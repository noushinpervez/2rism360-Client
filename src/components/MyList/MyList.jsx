                        ...
                        <>
                            <div className="flex flex-wrap stack my-6 w-full container lg:p-0 px-6">
                                { myList.slice(0, 3).map(myList => (
                                    <div key={ myList.uid } className="overflow-hidden rounded-md">
                                        <img
                                            className="h-40 w-80 max-w-full rounded-lg object-cover object-center transform transition-transform duration-1000 hover:scale-105 ease-in-out"
                                            src={ myList.image }
                                            alt={ myList.tourist_spot_name }
                                        />
                                    </div>
                                )) }
                            </div>
