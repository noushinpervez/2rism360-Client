        ...
        <section className="flex h-screen flex-row-reverse">
            ...
            <div className="hidden lg:flex items-center justify-center flex-1">
                <div className="w-full">
                    <img src="https://images.unsplash.com/photo-1545922016-87c93aaca2ce?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" className="object-cover w-full h-screen" />
                </div>
            </div>
            ...
            <div className="w-full bg-background text-text lg:w-1/2 flex items-center justify-center">
                <div className="max-w-md w-full p-6">
                    ...
                    <h1 className="text-sm font-semibold mb-6 opacity-40 text-center">Join Our Community for free </h1>
                    ...
                    <form className="space-y-4" onSubmit={ handleSubmit(onSubmit) }>
                        <div>
                            ...
                            { errors.fullName && <p className="pt-2 text-red-400 text-sm italic font-semibold opacity-70">This field is required*</p> }
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            { errors.photoURL && <p className="pt-2 text-red-400 text-sm italic font-semibold opacity-70">This field is required*</p> }
                        </div>
                        <div>
                            ...
                            { errors.password && errors.password.type === "required" && <p className="pt-2 text-red-400 text-sm italic font-semibold opacity-70">This field is required*</p> }
                            { errors.password && errors.password.type === "minLength" && <p className="pt-2 text-red-400 text-sm italic font-semibold opacity-70">Password must be at least 6 characters*</p> }
                            { errors.password && errors.password.type === "pattern" && <p className="pt-2 text-red-400 text-sm italic font-semibold opacity-70">Password must contain at least one uppercase letter and one lowercase letter</p> }
                        </div>
                        <div>
                    ...
                    <div className="mt-4 text-sm opacity-70 text-center">
                        <p>Already have an account? <Link to="/login" className="hover:underline text-primary font-bold">Login</Link>
                        </p>
                    </div>
                </div>
            </div>
